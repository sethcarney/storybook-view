    ...
    >
      <div className="flex items-center space-x-3">
        <div className="relative">
          <div className={`${classes.avatar} rounded-full bg-gray-300 flex items-center justify-center overflow-hidden`}>
            {avatar ? (
              <img 
                src={avatar} 
                alt={name}
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className={`${classes.email} truncate`}>
            {email}
          </p>
          {role && (
            <p className={`${classes.role} truncate`}>
              {role}
            </p>
          )}
        </div>
